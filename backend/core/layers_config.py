...
class LayerPaths:
    ...
    # Территории комплексного развития (для модуля паспортов участков)
    KRT = Path(os.getenv(
        "LAYER_KRT",
        "/mnt/graphics/NOVOKUZ/_Правила землепользования и застройки"
        "/3. ПЗИЗ НГО ред. от 31.10.2025/НИР 1858-23 Новокузнецк ГО"
        "/Правила землепользования и застройки"
        "/Территории комплексного развития/Территории_компл_развития.TAB"
    ))
